...
Or use [hirecheck](/analyze) to do this analysis automatically — it gives you an ATS score, flags missing keywords, and identifies rejection risks in about 15 seconds.
